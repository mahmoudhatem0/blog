		...
		<div class="container">
			...
			<div class="row">
			    	<div class="col-md-8">
                        <div class="row">
                            <br>
                         @foreach($categorys->aposts()->orderBy('created_at','desc')->get() as $post)
                        <div class="col-md-6 hot-post-right">
                            <div class="post post-thumb">
                                <a class="post-img" href="{{route('aposts.showui',['slug' => $post->slug ])}}"><img src="/storage/apost_image/{{$post->featrued}}" alt="" style="width:100%;height:100%;min-width:100%;min_height:100%"></a>
                                <div class="post-body">
